...
func (u User) Validate() ([]ValidationError, error) {
	...
	{
		vErr, err := validateLen("ID",u.ID,"36")
		if err != nil {
			return nil, err
		}
		if vErr != nil {
	...
	{
		vErr, err := validateRegex("Email",u.Email,"^\\w+@\\w+\\.\\w+$")
		if err != nil {
			return nil, err
		}
		if vErr != nil {
	...
	{
		vErr, err := validateInString("Role",string(u.Role),"admin,stuff")
		if err != nil {
			return nil, err
		}
		if vErr != nil {
	...
	{
		vErr, err := validateMin("Age",u.Age,"18")
		if err != nil {
			return nil, err
		}
		if vErr != nil {
	...
	{
		vErr, err := validateMax("Age",u.Age,"50")
		if err != nil {
			return nil, err
		}
		if vErr != nil {
	...
	{
		for _, v := range u.Phones {
			vErr, err := validateLen("Phones",v,"11")
			if err != nil {
				return nil, err
			}
			if vErr != nil {
